                ...
                <div class="property-container">
                    ...
                    <div class="size-container">
                        ...
                        <button @click="activeButton(size)" class="size-button" :style="{
                            backgroundColor:
                                activeSize.includes(size) ? '#501337' : '#FFFFFF',
                    ...
                    <div class="product-details-conatiner">
                        <!-- <div class="child-one"> -->
                                ...
                                <div class=" show-more-btn">
                                    <button v-if="showOrHideToggle" @click="addSomeData" class="more-show-data">Show More Details</button>
                                    <button v-else @click="hideSomeData" class="more-show-data">Show Less Details</button>
                                </div>
                        <!-- </div> -->
                        <!-- <div class="child-one">
...
export default {
    ...
    async fetch() {
        ...
        console.log("addfdfvxvasd", data.result);
    },
    ...
    methods: {
        ...
        getImportantDataForProduct() {
            if(this.PdpProduct.visible_attributes.length) {
                this.data = this.PdpProduct.visible_attributes.slice(this.start, this.end);
                if(this.end >= 0 && this.end <= this.PdpProduct.visible_attributes.length) {
